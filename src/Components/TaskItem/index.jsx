...
const TaskItem = ({ task, onView, onEdit, onDelete }) => {
  return (
    <>
      <div className="flex flex-col md:flex-row justify-between md:items-center bg-gray-50 px-4 py-3 rounded">
        <div className="flex flex-col md:flex-row items-center gap-3">
          ...
          <div className="lg:text-left md:text-center">
            ...
            <div className="text-gray-500 text-sm">
              <span className="font-semibold text-black mr-2">Type:</span>
        ...
        <div className="flex flex-col md:flex-row items-center gap-3 mt-2 md:mt-0 ">
          ...
          <div className="flex gap-4 md:gap-3 md:ml-5">
            <button
              ...
              onClick={() => onView({ type: "SHOW_MODAL" })}
            >
